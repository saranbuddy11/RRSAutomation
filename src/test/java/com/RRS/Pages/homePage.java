...
public class homePage extends PageObject{
	...
	@FindBy(xpath="//div[@id='hp-pff-banner']//h2[contains(text(),'FIND YOUR PERFECT FITTING SHOES FAST!')]")
	...
	@FindBy(xpath="//a[contains(@aria-label,'On Cloudrunner')]")
	List<WebElementFacade> OnCloudrunner_Lnk;
	...
	public void click_RRSHomeLogo_SVG_Button() {
		Actions a = new Actions(getDriver());
	      a.moveToElement(RRSHomeLogo_SVG).
	      click().build().perform();
	...
	public void homePage_Open() throws InterruptedException {
		...
		/*
		while(EmailCapturePopUp.isDisplayed()==true) {
			Thread.sleep(1000);
	...
	public void assert_categories_banner_has_appropriate_categories_name() {
		...
		Assert.assertTrue(OnCloudrunner_Lnk.get(0).containsText("Shop Women's"));
		Assert.assertTrue(OnCloudrunner_Lnk.get(1).containsText("Shop Men's"));
    }
	...
	public void user_click_on_in_running_shoes_category(String text) throws InterruptedException {
		CommonPage.javaScriptExecutor_Click(hottestBrands_Lnk.get(0));
	...
	@Step
	public void assert_shop_all_button_is_clickable_in_this_weeks_most_asked_for_shoe_section() throws InterruptedException {
	...
	@Step
	public void assert_shop_all_button_is_clickable_in_your_bestselling_performance_apparel_section() throws InterruptedException {
	...
	public void assert_recently_ordered_product_details_are_displayed_in_history_section() {
		...
		for (WebElementFacade ele : historySectionProduct_lnk) {
			if(ele.findBy("//div[contains(@class,'product-card-purchase')]/p").getText().contains("Ordered")) {
				Assert.assertTrue(ele.findBy("//div[contains(@class,'product-card-purchase')]/p").getText().contains("Ordered"));
				Assert.assertTrue(ele.findBy("//div[contains(@class,'product-card-purchase')]/p").getText().contains("ago"));
				flag = true;
				break;
			}
		}
	...
	@Step
	public void assert_recommended_for_you_product_details_are_displayed_in_history_section() throws InterruptedException {
	...
	@Step
	public void assert_shop_all_button_is_clickable_in_todays_top_sellers_in_america_section() throws InterruptedException {
	...
	@Step
	public void assert_shop_all_button_is_clickable_in_love_brooks_heres_their_newest_section() throws InterruptedException {
	...
	@Step
	public void user_click_on_in_vip_family_bestselling_performance_apparel_category(String text) throws InterruptedException {
		boolean flag = false;
