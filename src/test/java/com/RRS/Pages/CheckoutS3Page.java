...
public class CheckoutS3Page extends PageObject {
	...
	public void Checkout_ClickPlaceOrderBtn() throws InterruptedException {
		...
		Thread.sleep(10000);
		waitFor(orderConfirm_OrderNum_Lbl);
		orderConfirm_OrderNum_Lbl.shouldBeVisible();
	}

	@Step
	public void payment_ccNewCard(String CCName, String CC_CardNumber, String CC_ExpairyMonth, String CC_ExpairyYear,
			String CC_CVV) throws InterruptedException, AWTException {
		...
		Thread.sleep(5000);
		if (!CheckoutS3_SameAsShipping_ChkBox.isSelected()) {
	...
	public void clickUpgradedDeliveryBox() throws InterruptedException {
		...
		waitFor(CheckoutS3_UpgradedDelivery_ChkBox);
