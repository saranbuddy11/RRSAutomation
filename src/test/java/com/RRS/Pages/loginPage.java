...
public class loginPage extends PageObject{
	...
	public void Validate_ConfirmationMsg_ForgetPwd(String EmailID) {
		...
		assertThat(ForgetYourPassword_darkText_Lbl.containsText(", a reset password link has been sent. Please click the link in the email to create a new password"));
	}
	...
	public void click_Profile_SVG_Button() {
		Actions a = new Actions(getDriver());
	      a.moveToElement(Profile_SVG_Btn).
	      click().build().perform();
	}
