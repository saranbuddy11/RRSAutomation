...
public class myAccount_StepDefinitions extends baseClass {
	...
	public void user_click_on_my_account_button_in_home_page() throws InterruptedException {
	...
	public void user_click_on_see_all_orders_button() throws AWTException {
		myAccountPage.pageScrollUp();
		myAccountPage.user_click_on_see_all_orders_button();
	}

	@Then("User click on See All orders button for Non-VIP user")
	public void user_click_on_see_all_orders_button_nonVIP() throws InterruptedException {
		myAccountPage.user_click_on_see_all_orders_button_nonVIP();
	}
